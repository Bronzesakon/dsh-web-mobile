...
@media (max-width: 1023px) {
  ...
  /* Our Files action is absolutely pinned to the far right and would cover
     whichever header popover trigger (jobs / subagent) sits at the right
     edge. Hide the header Files action while such a trigger is present —
     the drawer footer keeps a Files entry, so file access is not lost. */
