...
@media (max-width: 1023px) {
  ...
  [data-phase] header [class*="_root"]:not([class*="_switcherRoot"]):has(> button[class$="_trigger"]) {
    order: 2 !important;
    flex: 0 0 auto !important;
  ...
  [data-phase] header [class*="_root"]:not([class*="_switcherRoot"]):has(> button[class$="_trigger"]) > button,
  [data-phase] header [class*="_root"]:not([class*="_switcherRoot"]):has(> button[class$="_trigger"]) > button * {
    white-space: nowrap !important;
  }
  /* The lineage count's leading "/" (ZKlsPq_separator — official desktop
     ...
     stays. */
  [data-phase] header [class$="_crumbs"] [class$="_separator"] {
    display: none !important;
  }
  ...
  @media (max-width: 440px) {
    ...
    [data-phase] header:has([class$="_crumbs"] [class*="_root"]) [class$="_label"]:has(> svg) {
  ...
  @media (max-width: 559px) {
    ...
    [data-phase] header:has([class$="_crumbs"] [class*="_root"]) [class$="_headerActions"] [class*="_root"]:not([class*="_switcherRoot"]):has(> button[class$="_trigger"]) [class$="_count"] {
      display: none !important;
    }
    [data-phase] header:has([class$="_crumbs"] [class*="_root"]):has([class$="_headerActions"] [class*="_root"]) [class$="_label"]:has(> svg) {
      max-width: 18px !important;
      min-width: 18px !important;
      padding-left: 18px !important;
      padding-right: 0 !important;
