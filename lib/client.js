...
function MobileNavOverlay({ toggleSidebar, t }) {
    ...
    if (!mobile)
        return null;
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [open && ((0, jsx_runtime_1.jsx)("div", { "data-mobile-nav": "backdrop", role: "button", "aria-label": t('backdrop'), onClick: () => toggleSidebar() })), fabVisible && !open && ((0, jsx_runtime_1.jsx)("button", { type: "button", "data-mobile-nav": "fab", "aria-label": t('open'), title: t('open'), onClick: () => toggleSidebar(), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconPanelLeftOutline16, { size: 18 }) })), (0, jsx_runtime_1.jsxs)("button", { type: "button", "data-mobile-nav": "preview-full-toggle", "aria-label": t('previewFullscreen'), title: t('previewFullscreen'), onClick: () => findFrame()?.toggleAttribute('data-mobile-preview-full'), children: [(0, jsx_runtime_1.jsx)("svg", { className: "dsh-mobile-nav-full-in", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: (0, jsx_runtime_1.jsx)("path", { d: "M6 2H2v4M10 2h4v4M6 14H2v-4M10 14h4v-4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) }), (0, jsx_runtime_1.jsx)("svg", { className: "dsh-mobile-nav-full-out", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: (0, jsx_runtime_1.jsx)("path", { d: "M6 2v4H2M10 2v4h4M6 14v-4H2M10 14v-4h4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) })] })] }));
}
};
    ...
    ctx.effect(() => {
        ...
        const install = () => {
            ...
            const onTap = (event) => {
                ...
                if (row.querySelector('[class$="_treeArrow"]') !== null)
                    return;
