...
@media (max-width: 1023px) {
  ...
  /* --- Session header on mobile ---
     Keep the host-owned metadata in one responsive row. The title is the
     first shrinkable lane; mode text may ellipsize after it yields, while the
     running/subagent controls and Files action keep their hit areas. */
  [data-phase] header {
